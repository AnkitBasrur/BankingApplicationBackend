...
public class PaymentController {
	...
	@GetMapping("/requestOTP/{acc_num}/{message}")
	public String requestOTP(@PathVariable(value = "acc_num") String acc_num, @PathVariable(value = "message") String message) {
		return paymentService.requestOTP(acc_num, message);
	}
